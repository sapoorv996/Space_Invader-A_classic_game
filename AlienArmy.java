...
public class AlienArmy {
	...
	private BarrierProtect protection = null;

	private SpaceInvaders spaceInvaders;

	Image alienImage = null;

	public AlienArmy(BarrierProtect p, Ship s, SpaceInvaders si, Image ai) {
		protection = p;
		ship = s;
		spaceInvaders = si;
		alienImage = ai;
	...
	/*
	 * Initialize the 3 rows of aliens for army
	 */
	...
	public void moveArmy() {
		...
		for(int i = 0; i < 10; i++) {
			if(rowThree[i].checkShipCollision(ship.getXPos(), ship.getYPos())) {
//				ship.hitState = true;
                spaceInvaders.defenderLives -= 1;
			} else if(rowTwo[i].checkShipCollision(ship.getXPos(), ship.getYPos())) {
//				ship.hitState = true;
                spaceInvaders.defenderLives -= 1;
			} else if(rowOne[i].checkShipCollision(ship.getXPos(), ship.getYPos())) {
//				ship.hitState = true;
                spaceInvaders.defenderLives -= 1;
			}
		}
		...
		if (!rowThree[rnd1].hasBeenHit()) {
			AlienShot as = new AlienShot(rowThree[rnd1].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowThree[rnd1].getYPos(), ship, protection);
			alienShots.addElement(as);
			makeSomeNoise();
		} else if (!rowTwo[rnd1].hasBeenHit()) {
			AlienShot as = new AlienShot(rowTwo[rnd1].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowTwo[rnd1].getYPos(), ship, protection);
			alienShots.addElement(as);
			makeSomeNoise();
		} else if(!rowOne[rnd1].hasBeenHit()){
			AlienShot as = new AlienShot(rowOne[rnd1].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowOne[rnd1].getYPos(), ship, protection);
			alienShots.addElement(as);
			makeSomeNoise();
		}
		
//		if (!rowThree[rnd2].hasBeenHit()) {
//			AlienShot as = new AlienShot(rowThree[rnd2].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowThree[rnd2].getYPos(), ship, protection);
//			alienShots.addElement(as);
//		} else if (!rowTwo[rnd2].hasBeenHit()) {
//			AlienShot as = new AlienShot(rowTwo[rnd2].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowTwo[rnd2].getYPos(), ship, protection);
//			alienShots.addElement(as);
//		} else if(!rowOne[rnd2].hasBeenHit()) {
//			AlienShot as = new AlienShot(rowOne[rnd2].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowOne[rnd2].getYPos(), ship, protection);
//			alienShots.addElement(as);
//		}
//		
//		if (!rowThree[rnd3].hasBeenHit()) {
//			AlienShot as = new AlienShot(rowThree[rnd3].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowThree[rnd3].getYPos(), ship, protection);
//			alienShots.addElement(as);
//		} else if (!rowTwo[rnd3].hasBeenHit()) {
//			AlienShot as = new AlienShot(rowTwo[rnd3].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowTwo[rnd3].getYPos(), ship, protection);
//			alienShots.addElement(as);
//		} else if(!rowOne[rnd3].hasBeenHit()){
//			AlienShot as = new AlienShot(rowOne[rnd3].getXPos()+(int)(Alien.ALIEN_WIDTH/2), rowOne[rnd3].getYPos(), ship, protection);
//			alienShots.addElement(as);
//		}
	}
	...
	private void makeSomeNoise() {
		...
		try {
			audioInputStream = AudioSystem.getAudioInputStream(this.getClass().getResource("./blip.wav"));
